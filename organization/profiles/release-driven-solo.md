...
tool-svg2tsx の current release-driven development で使用する Operating Model を定義します。
...
- This package has no standalone application target; integration behavior is verified through the host layout.
- Source ownership stays in this repository; host integration evidence stays bound to the my-web-2025 candidate/layout.
- Bun in mise is the project-init Skills CLI prerequisite; it does not silently replace the host/application package-manager authority.
